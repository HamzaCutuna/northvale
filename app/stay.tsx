...
export default function Stay() {
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!arrival || !departure || arrival < localToday || departure <= arrival) {
    ...
    <section id="stay" className={styles.stay} aria-labelledby="stay-title">
      <div className={styles.introduction}>
        ...
        <ul className={styles.experiences}>
          <li><span>01</span> Fireside evenings in warm timber interiors</li>
          <li><span>02</span> Lake-facing windows and mountain views</li>
          <li><span>03</span> Slow mornings on your private terrace</li>
        </ul>
      </div>
      <form className={styles.booking} onSubmit={submit} onChange={() => {setSummary("");setError("");}}>
        <p className={styles.kicker}>Your time at Northvale</p><h3>A few days, just for you.</h3>
        <div className={styles.fields}>
          <DatePicker error={!!error} onChange={()=>{setSummary("");setError("");}} />
